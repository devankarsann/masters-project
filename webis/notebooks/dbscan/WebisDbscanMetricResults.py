...
class DbscanMetricResults:
    ...
    def __init__(self, stemmed, representation, eps, min_samples):
        ...
        self.filename = '../../../results/' + self.dataset + '_' + self.strategy + '_' + stemmed + '_' + representation + '_' + str(eps).replace('.', '') + '_' + str(min_samples) + '.metrics'
    ...
    def set_silhouette(self, silhouette_score, silhouette_map):
        ...
        self.silhouette_map = silhouette_map
    ...
    def set_total_hit_metrics(self, checks_count, checks_map, hits_count, hits_map, hit_percent_value, hit_percent_map):
        ...
        self.total_hit_percent_count = hit_percent_value
